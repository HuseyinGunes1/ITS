...
namespace ITS.Shared
{
   public class ErrorDto
    {
        public List<string> Errors { get; private set; } //bir client bir endpointe istek yaptığında birden fazla hata meydana gelebilir bu hataları bu listede tutarız
